...
export function TechDivider() {
  return (
    <section id="software" className="relative scroll-mt-24 overflow-hidden bg-white">
      ...
      <div className="relative bg-[linear-gradient(180deg,#ffffff_0%,#f4f8fc_100%)] px-4 py-12 md:px-8 md:py-16">
        <div className="absolute inset-0 bg-precision-grid bg-[size:72px_72px] opacity-35 [mask-image:radial-gradient(ellipse_at_center,black_0%,black_46%,transparent_86%)]" />
        <div className="software-showcase-card relative z-20 mx-auto max-w-7xl overflow-hidden">
          ...
          <div className="relative grid gap-8 py-7 md:py-10 lg:min-h-[600px] lg:grid-cols-[0.48fr_0.52fr] lg:py-14">
              ...
              <div className="grid gap-3 md:grid-cols-4">
                {softwareFeatures.map((item, index) => {
                  ...
                  return (
                    <article
                      key={item.title}
                      className="software-feature-card group relative border border-slate-900/10 bg-white/78 p-6 shadow-[0_18px_54px_rgba(42,55,78,0.07)] backdrop-blur transition duration-500 hover:-translate-y-1 hover:bg-white md:min-h-[210px] md:p-7"
